...
class PaymentFragment : Fragment() {
    ...
    var txtshowprice: TextView? = null
    var file: File? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        totalPrice = bundle?.get("y").toString()

        //check permission
        permission()

        txtshowprice = root.findViewById(R.id.txtshowprice)
        ...
        btnUpload?.setOnClickListener {
          //  if()
            ...
            updatestatus(bundle?.get("orderID").toString())
        ...
        Log.d("rrrr",bundle?.get("orderID").toString())
        txtshowprice?.setText(totalPrice)
        imageViewSlipSelection?.setImageResource(R.drawable.image1)
    ...
    {
        var url: String =
                getString(R.string.root_url) + getString(R.string.updatestatus_url) +orderID
